insert into PATIENT (NAME, SURNAME, patronymic, PHONE)values ('Leon', 'Yurocjkin', 'Arrighetti', '55863436981');
...
insert into DOCTOR (NAME, SURNAME, patronymic, specialty)values ('Zacherie', 'Housbie', 'MacCahee', 'SURGEON');
...
insert into RECIPE (description, patient_id, doctor_id, creation_date, validity, priority) values ('dolor vel est donec odio justo sollicitudin ut suscipit a feugiat et eros vestibulum ac est lacinia nisi', 8, 5, '2019-08-19', 2,'NORMAL');
